        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'create-card.php' ? 'active' : '' ?>" 
                   href="../New Cards/card_creation_image.html" style="color: rgba(255,255,255,0.8); padding: 12px 20px; border-radius: 8px; margin: 2px 10px; transition: all 0.3s ease;">
                    <i class="fas fa-plus-circle me-2"></i>Create New Card
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" 
                   href="../New Cards/view_all_cards.php" target="_blank" style="color: rgba(255,255,255,0.8); padding: 12px 20px; border-radius: 8px; margin: 2px 10px; transition: all 0.3s ease;">
