            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 main-content" style="padding: 15px;">
                <div class="pb-2 mb-3">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
                        ...
                        <a href="../New Cards/card_creation_image.html" class="btn btn-primary">
                                    ...
                                    <?php if (empty($cards)): ?>
                                        <tr>
                                            <td colspan="6" class="text-center py-4 text-muted">
                                                No cards found. <a href="../New Cards/card_creation_image.html">Create your first card</a>
                                            </td>
                                        </tr>
                                    <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="../New Cards/view_card.php?id=<?= $card['unique_id'] ?>" class="btn btn-outline-primary" title="View" target="_blank">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="../New Cards/card_creation_image.html?edit=<?= $card['unique_id'] ?>" class="btn btn-outline-secondary" title="Edit" target="_blank">
