...
require_once '../New Cards/config.php';
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-grid gap-2">
                                    <a href="../New Cards/card_creation_image.html" class="btn btn-outline-primary">
                                        <i class="fas fa-plus-circle me-2"></i>Create New Card
                                    </a>
                                    <a href="../New Cards/view_all_cards.php" class="btn btn-outline-success" target="_blank">
                                        <i class="fas fa-eye me-2"></i>View All Cards
                                    </a>
                                    <a href="../New Cards/index.html" class="btn btn-outline-warning" target="_blank">
