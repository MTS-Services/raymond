    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="submenu">
                ...
                <a href="card_creation_image.html" class="menu-item">
    ...
    <div class="main-content">
        <div class="top-header">
            ...
            <div class="header-actions">
                <a href="card_creation_image.html" class="btn-create">
                    <i class="fas fa-plus"></i>
                    Create New Card
                </a>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="card_creation_image.html?edit=<?php echo htmlspecialchars($card['unique_id']); ?>" 
